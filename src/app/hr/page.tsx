    ...
    <main id="main" data-accent style={{ ["--accent" as string]: "var(--ochre)" }}>
      ...
      <section className="hairline-b" id="playground">
        <div className="wrap" style={{ padding: "72px 24px" }}>
          <Reveal>
            <Stamp>THE CONSOLE (CONCEPT)</Stamp>
        ...
        <div className="wrap" style={{ padding: "72px 24px", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: 40, alignItems: "start" }}>
          <Reveal>
            ...
            <p style={{ color: "var(--ghost)", maxWidth: "50ch" }}>
              It reads the records, respects your pay bands, and drafts what you
              would have written on your best day. Watch it handle two raise
              requests fairly.
            </p>
          </Reveal>
          <Reveal delay={100}>
